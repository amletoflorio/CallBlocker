...
object ChangelogData {
    ...
    val entries = listOf(
        ChangelogEntry(
            ...
            date = "2026-04-24",
            changes = listOf(
                ChangeItem(ChangeType.FIX,     com.amlet.callblocker.R.string.changelog_1_8_4_1),
                ChangeItem(ChangeType.IMPROVE, com.amlet.callblocker.R.string.changelog_1_8_4_2),
            )
        ),
        ChangelogEntry(
            version = "1.8.3",
            date = "2026-04-22",
            changes = listOf(
                ChangeItem(ChangeType.IMPROVE, com.amlet.callblocker.R.string.changelog_1_8_3_1),
            )
        ),
        ChangelogEntry(
            version = "1.8.2",
            date = "2026-04-13",
            changes = listOf(
                ChangeItem(ChangeType.NEW, com.amlet.callblocker.R.string.changelog_1_8_2_1),
            )
        ),
        ChangelogEntry(
            version = "1.8.1",
            date = "2026-04-07",
            changes = listOf(
                ChangeItem(ChangeType.NEW,     com.amlet.callblocker.R.string.changelog_1_8_1_1),
                ChangeItem(ChangeType.NEW,     com.amlet.callblocker.R.string.changelog_1_8_1_2),
                ChangeItem(ChangeType.NEW,     com.amlet.callblocker.R.string.changelog_1_8_1_3),
                ChangeItem(ChangeType.NEW,     com.amlet.callblocker.R.string.changelog_1_8_1_4),
                ChangeItem(ChangeType.NEW,     com.amlet.callblocker.R.string.changelog_1_8_1_5),
                ChangeItem(ChangeType.IMPROVE, com.amlet.callblocker.R.string.changelog_1_8_1_6),
            )
        ),
        ChangelogEntry(
            version = "1.8.0",
